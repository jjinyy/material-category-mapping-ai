...
* Approximate statistics based on the first 3 samples:
  ...
  | details | <ul><li>min: 4 tokens</li><li>mean: 4.33 tokens</li><li>max: 5 tokens</li></ul> | <ul><li>min: 4 tokens</li><li>mean: 4.33 tokens</li><li>max: 5 tokens</li></ul> | <ul><li>0: ~33.33%</li><li>1: ~66.67%</li></ul> |
* Samples:
  | sentence_0                | sentence_1                | label          |
  |:--------------------------|:--------------------------|:---------------|
